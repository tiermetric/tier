...
//
// the maintainer ruled the unqualified semantics (option C) on 2026-08-03: strict equality, plus
...
// TestScoresRepoFilter_UnqualifiedExcludedAndDisclosed asserts BOTH halves of the maintainer's
